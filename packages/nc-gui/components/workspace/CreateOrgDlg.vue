...
const createGroup = async () => {
    creating.value = true
    try {
        const base = await $fetch(`/api/v1/organizations`, {
            baseURL,
            method: 'POST',
        ...
        message.success("Create Organization Successful")
        setTimeout(() => {
            location.reload();
        }, 500);
    }
    ...
    <NcModal v-model:visible="dialogShow" size="small">
        <template #header>
            ...
            <div class="flex flex-row items-center">
                <GeneralIcon icon="users" class="mr-2.5 !text-lg !h-4" />
                {{
        ...
        <div class="mt-3">
            ...
            <div class="flex flex-row justify-end mt-7 gap-x-2">
                ...
                <NcButton data-testid="docs-create-proj-dlg-create-btn" :loading="creating"
