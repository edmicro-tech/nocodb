...
<template>
  ...
  >
    <div class="relative">
      <img class="hidden dark:block" :width="size" :height="size" alt="Edmicro NocoDB" src="~/assets/img/branch/edmicro_icon.png" />
      <img class="dark:hidden" :width="size" :height="size" alt="Edmicro NocoDB" src="~/assets/img/branch/edmicro_icon.png" />
