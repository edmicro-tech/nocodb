...
<template>
  ...
  >
    <div class="relative">
      <img class="hidden dark:block" :width="size" :height="size" alt="Edmicro MicDB" src="~/assets/img/brand/mic_vietnam_logo.png" />
      <img class="dark:hidden" :width="size" :height="size" alt="Edmicro MicDB" src="~/assets/img/brand/mic_vietnam_logo.png" />
