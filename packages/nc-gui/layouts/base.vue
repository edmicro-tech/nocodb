        ...
        >
          <a-tooltip placement="bottom">
            ...
            <div class="flex items-center gap-2">
              <img v-if="!isDashboard" width="170" alt="Edmicro MicDB" src="~/assets/img/brand/mic_logo_1.png" />
              <img v-else width="25" alt="Edmicro MicDB" src="~/assets/img/brand/mic_vietnam_logo.png" />
            </div>
          </a-tooltip>
        </div>
