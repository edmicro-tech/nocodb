        ...
        >
          ...
          >
            <a-tooltip placement="bottom">
              ...
              <img width="25" class="-mr-1" alt="Edmicro NocoDB" src="~/assets/img/branch/edmicro_icon.png" />
            </a-tooltip>
          </div>
          ...
          >
            <a-tooltip placement="bottom">
              ...
              <img width="25" alt="Edmicro NocoDB" src="~/assets/img/branch/edmicro_icon.png" />
            </a-tooltip>
          </a>
