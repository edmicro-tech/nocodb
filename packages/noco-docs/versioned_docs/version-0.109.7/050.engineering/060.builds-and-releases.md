...
description: "MicDB creates Docker and Binaries for each PR"
---
## Builds of MicDB

There are 3 kinds of docker builds in MicDB

- Release builds [nocodb/nocodb](https://hub.docker.com/r/nocodb/nocodb) : built during MicDB release. 
...
- Click [MicDB release action](https://github.com/nocodb/nocodb/actions/workflows/release-nocodb.yml)
...
- MicDB creates every 6 hours from develop branches and publishes as nocodb/nocodb-daily
...
MicDB has github actions which creates docker and binaries for each PR! And these can be found as a **comment on the last commit** of the PR.  
...
MicDB creates Docker and Binaries for each PR.
