...
description: "Contribute to MicDB's i18n translation"
---

- MicDB supports 30+ foreign languages & community contributions are now simplified via [Crowdin](https://crowdin.com/).
...
- Join [MicDB](https://crowdin.com/project/nocodb) project
...
-   **Objects**: objects from MicDB POV (project, table, field, column, view, page, and such)
