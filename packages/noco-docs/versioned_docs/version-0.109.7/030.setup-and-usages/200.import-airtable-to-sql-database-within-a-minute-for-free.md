...
MicDB allows a complete import of your Airtable to any MySQL, Postgres, SQLite and SQL server databases within minutes.

:::note

Import from Airtable is in beta version. See <a href="https://github.com/nocodb/nocodb/discussions/2122" target="_blank">Importing Airtable To MicDB</a> for the migration notes.
...
## Import Airtable to MicDB

:::note

Prerequisites: <br/> - A MicDB Project <br/> - Airtable Credentials
