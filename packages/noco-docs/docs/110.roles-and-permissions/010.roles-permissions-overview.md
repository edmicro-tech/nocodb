...
description: 'Learn about roles and permissions in MicDB.'
tags: ['Roles', 'Permissions', 'Overview']
keywords: ['Roles overview', 'Permissions overview', 'MicDB roles', 'MicDB permissions', 'MicDB roles overview', 'MicDB permissions overview']
---


In MicDB, we have roles that determine what people can do in a Workspace or Base. 
...
## Roles
Roles serve as the basis for user privileges in MicDB. They are associated with members at two levels: 
...
ensures adaptable user permissions and access management in MicDB.
