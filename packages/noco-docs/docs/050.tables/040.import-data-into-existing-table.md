...
description: 'Learn how to import data into an existing table in MicDB.'
tags: ['Tables', 'Upload', 'CSV', 'Excel', 'JSON']
keywords: ['MicDB table', 'import data into table', 'import data from csv', 'import data from excel', 'import data from xlsx']
---
...
2. **Mapping Fields** (Optional)
    ...
    - MicDB automatically maps destination field names based on the source field names.
